...
def predict_single_image(image_path, model_path, image_size=224):
    """
    ...
    model = DINOv3Regressor(head_width=256, dropout_p=0.0)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="outputs/checkpoints/best_model.pth", help="Path to best_model.pth")
